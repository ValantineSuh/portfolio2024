    ...
    <div data-name="home" id='home' className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800'>
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full pr-20 '>
                <h2 className='text-4xl sm:text-3xl mt-10 font-bold text-white md:text-7xl md:mt-auto opacity-55' >
                ...
                <div>
                    ...
                    to-blue-500 cursor-pointer group opacity-55'> {/**the group attribute is to make sure you group same props to another tag */}
                        Portfolio
